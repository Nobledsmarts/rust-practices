...
fn main() {
    ...
    scope(|scope| {
        ...
        let handle1 = scope.spawn(|_| {
            ...
            // pause_ms(0);
            // pause_ms(500);
            // txc.send("handle C : B").unwrap();
        });
    
        // tx.send("from outside").unwrap();
    
        // let handle_d = scope.spawn(|_| {
        //     pause_ms(0);
        //     txd.send("handle D : A").unwrap();
        //     pause_ms(500);
        //     txd.send("handle D : B").unwrap();
        // });
        ...
        // handle_d.emit("sending from main thread");
